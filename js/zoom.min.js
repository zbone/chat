(function(e) {
    ...
    function a() {
        ...
        if (t.length == 0) t = e(".img_wrap:last-child");
        t.find("a").trigger("click")
    }
    function f() {
        var t = i.parent("li").next();
        if (t.length == 0) t = e(".img_wrap:first-child");
    ...
    o = e(window).height(); (function() {
        ...
        if (e(".img_wrap a").length == 1) e(".img_wrap a")[0].addClass("zoom");
        e(".zoom, .img_wrap a").on("click", u)
    })(); (function() {
